            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="py-2">
                            <label for="" class="uppercase text-gray-700 text-xm block bg-gray-500/50 p-2">Nombre del Curso</label>
                            <p class="p-2">{{ $certificado->course->name }}</p>
                        </div> 

                        <div>
                            <a href="{{ route('certificates-courses.edit', $certificado) }}" class="text-ms bg-gray-800 text-white  px-4 py-2">Editar</a>
                        </div>
